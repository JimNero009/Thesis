...
\begin{equation}
\begin{split}
|M_{qg \to q...Q\bar{Q}}^{HEJ}|^2 &= |M_{qg \to qQ\bar{Q}}|^2 \times \prod_{i=1}^{n-3}  C_A \left(\frac{-V(q_i,q_{i+1}) \cdot V(q_i,q_{i+1})}{\hat{t}_i \hat{t}_{i+1}} \right) \\
...
\begin{equation}
\begin{split}
|M_{qq' \to q...Q\bar{Q}...q'}^{HEJ}|^2 &= |M_{qq' \to qQ\bar{Q}q'}|^2 \times \prod_{i=1}^{n_a} C_A \left(\frac{-V(q_i,q_{i+1}) \cdot V(q_i,q_{i+1})}{\hat{t}_{i+1}^2} \right) \\
